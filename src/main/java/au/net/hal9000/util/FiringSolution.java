package au.net.hal9000.util;

import au.net.hal9000.units.Vec2;


/**
 * A library to calculate the firing solution to hit a target moving linearly in
 * 2D.
 */
...
public class FiringSolution {
     ...
     * velocity 'v', to hit a target, 'targetPos'.
     *
     * @param Object
     *            src position of shooter
     * @param targetPos
     *            target position
     ...
     * 
     *         Credit: broofa http://stackoverflow.com/a/3487761/1647851
     */
    public static Vec2 calculate(Vec2 src, Vec2 targetPos, Vec2 targetVelocity,
        ...
        if (ts != null) {
            ...
            if (t < 0)
                t = Math.max(t0, t1);
            if (t > 0) {
                sol = new Vec2(targetPos.x + targetVelocity.x * t, targetPos.y
                        + targetVelocity.y * t);
            }
        }
        return sol;
